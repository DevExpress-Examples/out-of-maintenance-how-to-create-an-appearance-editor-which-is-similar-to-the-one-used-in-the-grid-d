...
Namespace WindowsApplication3
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.gridControl1.Size = New System.Drawing.Size(548, 475)
			...
			Me.gridView1.Appearance.GroupPanel.BackColor2 = System.Drawing.Color.FromArgb((CInt(Fix((CByte(192))))), (CInt(Fix((CByte(255))))), (CInt(Fix((CByte(192))))))
			Me.gridView1.Appearance.GroupPanel.Options.UseBackColor = True
			Me.gridView1.Appearance.HorzLine.BackColor = System.Drawing.Color.Navy
			Me.gridView1.Appearance.HorzLine.Options.UseBackColor = True
			Me.gridView1.Appearance.Row.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(192))))), (CInt(Fix((CByte(192))))), (CInt(Fix((CByte(255))))))
			Me.gridView1.Appearance.Row.BackColor2 = System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(192))))), (CInt(Fix((CByte(255))))))
...
'			Me.barButtonItem1.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.OnItemClick);
			' 
			' popupMenu1
			' 
